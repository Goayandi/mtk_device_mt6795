...
$(call inherit-product, device/vanzo/vanzo6795_lwt_l1/device.mk)
...
PRODUCT_NAME := full_vanzo6795_lwt_l1
PRODUCT_DEVICE := vanzo6795_lwt_l1
PRODUCT_MODEL := vanzo6795_lwt_l1
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= vanzo6795_lwt_l1_debug_defconfig
else
KERNEL_DEFCONFIG ?= vanzo6795_lwt_l1_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= vanzo6795_lwt_l1
LK_PROJECT ?= vanzo6795_lwt_l1
